...
// runConfigEncrypt implements `bubblefish config encrypt`.
...
// runConfigDecrypt implements `bubblefish config decrypt`.
...
// runConfigShowSecrets implements `bubblefish config show-secrets`.
